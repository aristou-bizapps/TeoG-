...
=========================================================================================================================
1       HS      2026-01-20      Create new "THL Unposted Tax Invoice" report
*/

//HS.1+
report 50006 "ATU_THL Unposted Tax Invoice"
{
    Caption = 'ATU THL Tax Invoice';
    DefaultRenderingLayout = "ATU_THL Unposted Tax Invoice";
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(ATU_DiscountAmt; ATU_gReportMgmt.ATU_GetDiscountAmount("Sales Header")) { }
            ...
            column(ATU_GSTPercentageCaption; StrSubstNo('GST %1%', ATU_gReportMgmt.ATU_GetTaxPercentage("Sales Header"))) { }
            ...
            begin
                ...
                ATU_gReportMgmt.ATU_GetSalesBillToAddress("Sales Header", ATU_gBillToAddress);
    ...
    rendering
    {
        layout("ATU_THL Unposted Tax Invoice")
        {
            Type = RDLC;
            LayoutFile = './src/report layout/RL_50006_ATU_THL Unposted Tax Invoice.rdl';
        }
    }
