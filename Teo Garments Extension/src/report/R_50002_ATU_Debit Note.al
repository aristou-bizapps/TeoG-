...
=========================================================================================================================
1       HS      2026-01-20      Create new "Debit Note" report
*/

//HS.1+
report 50002 "ATU_Debit Note"
{
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/report layout/RL_50002_ATU_Debit Note.rdl';
        }
    }
