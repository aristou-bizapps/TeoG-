...
=========================================================================================================================
1       HS      2026-01-20      Create new "Purchase Order Material" report
*/

//HS.1+
report 50004 "ATU_Purchase Order Material"
{
    Caption = 'ATU Purchase Order Material';
    DefaultRenderingLayout = "ATU_Purchase Order Material";
    ...
    rendering
    {
        layout("ATU_Purchase Order Material")
        {
            Type = RDLC;
            LayoutFile = './src/report layout/RL_50004_ATU_Purchase Order Material.rdl';
        }
    }
